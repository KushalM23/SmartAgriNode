...
try:
    ...
    print("⚠️  Note: You need to execute the SQL schema manually in Supabase SQL Editor")
    ...
    try:
        ...
        print("⚠️  Tables not found. Please run the SQL schema in Supabase SQL Editor.")
        print(f"   Error: {str(e)}")
